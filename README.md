...
Конструктор класса принимает данные в виде контейнера с типом HTMLElement.\
...
Конструктор класса принимает данные в виде объекта, часть или все свойства которого относятся к обобщенному типу `<T>`, а также инстант брокера событий.\
...
В конструкторе класс принимает контейнер и инстант брокера событий.
Поля класса:
...
В конструктор класса передается название класса блока, контейнер и опционально коллбэк для взаимодействия с интерактивными элементами карточки.\
...
В конструктор класса передается контейнер и опционально коллбэк для взаимодействия с интерактивными элементами карточки.\
В классе устанавливаются слушатели на все интерактивные элементы, в результате взаимодействия с которыми пользователя генерируются соответствующие события.\
Поля класса:
...
В конструктор класса передается контейнер и инстант брокера событий.\
В классе устанавливаются слушатели на все интерактивные элементы, в результате взаимодействия с которыми пользователя генерируются соответствующие события.\
Поля класса:
...
В конструктор класса передается контейнер и коллбэк для взаимодействия с кнопкой.\
Поля класса:
...
В конструктор класса передается URL для CDN, начальный URL для запросов и опционально настройки для запросов.\
Поля класса:
